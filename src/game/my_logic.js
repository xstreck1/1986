game.module(
    ...
    var border_arrows = [
        ...
        [12, 10, 1], [13, 5, 0], [13, 6, 0], [13, 7, 0], [13, 8, 0], [13, 9, 0]
    ];
    ...
    var inland_arrows = [
        ...
        [2,6,2], [3,6,2], [4,6,2], [5,6,2], [6,6,1], [7,6,1], [8,6,1], [9,6,0], [10,6,0], [11,6,0], [12,6,0],
        [3,7,2], [4,7,2], [5,7,2], [6,7,1], [7,7,1], [8,7,1], [9,7,1], [10,7,1], [11,7,0], [12,7,0],
        [3,8,2], [4,8,2], [5,8,2], [6,8,1], [7,8,1], [8,8,1], [9,8,1], [10,8,1], [11,8,1], [12,8,0], 
